...
namespace JLChnToZ.VRC.Foundation.I18N.Editors {
    public class LanguageEditorWindow : EditorWindow {
        ...
        static void UpdateTitle(GUIContent titleContent, string languageKey, bool unsaved = false) {
        ...
        void OnEnable() {
            ...
            UpdateTitle(titleContent, "LanguageEditor.title");
