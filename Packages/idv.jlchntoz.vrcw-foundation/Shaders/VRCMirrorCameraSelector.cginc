...
uint _VRChatCameraMode; // 0 = Normal, 1 = VR Handheld Camera, 2 = Desktop Handheld Camera, 3 = Screenshot
uint _VRChatMirrorMode; // 0 = Normal, 1 = VR Mirror, 2 = Desktop Mirror
uint _VRChatFaceMirrorMode; // 0 = Not in Face Mirror, 1 = In Face Mirror
